...
$(function () {
  ...
  submitNode.on('click', function (event) {
    event.preventDefault()
     var img = resultNode.find('img, canvas')[0]
      ...
      img.toBlob(function (blob) {
        ...
        $.ajax('/postimg', {
          ...
          success: function (data) {
            ...
            $('#result1').children().replaceWith()

           
          $.each(data.vgg, function( index, value ) {
            var price = value['price']
            var linkweb = value['linkweb']
            var lable = value['lable']


            
            var txt= '<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">'+
            '<figure class="effect-ming tm-video-item">'+
               ' <img src="'+linkweb+'" alt="Image" class="img-fluid">'+
            ...
            '<div class="d-flex justify-content-between tm-text-gray">'+
                '<span class="tm-text-gray-light">vgg</span>'+
                '<span>'+price +'$</span>'+
            '</div>'+
        '</div>'
          // var txt = '<div class="col-md-2 col_1" >'+
